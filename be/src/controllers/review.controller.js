...
const createReview = async (req, res, next) => {
  ...
  const { review, voucher, voucherEligibilityMessage, isEligibleForVoucher } = await reviewService.createReview(userId, orderId, productId, rating, comment);
